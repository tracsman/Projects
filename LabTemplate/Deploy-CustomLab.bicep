    ...
    subnets: [
      {
        name: 'Tenant'
        properties: {
          addressPrefix: '10.${SecondOctet}.${CustomerNumber}.0/27'
        }
      }
      {
        name: 'Network'
        properties: {
          addressPrefix: '10.${SecondOctet}.${CustomerNumber}.32/27'
        }
      }
      {
        name: 'Local'
        properties: {
          addressPrefix: '10.${SecondOctet}.${CustomerNumber}.64/27'
        }
      }
      {
        name: 'Management'
        properties: {
          addressPrefix: '10.${SecondOctet}.${CustomerNumber}.96/27'
        }
      }
      {
        name: 'GatewaySubnet'
        properties: {
          addressPrefix: '10.${SecondOctet}.${CustomerNumber}.128/27'
        }
      }
    ]
  }
