...
public class AddressesController : Controller
{
    ...
    public AddressesController(LabConfigContext context, ILogger<AddressesController> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    public async Task<IActionResult> Index()
    {
        ...
        {
            _logger.LogWarning("Permission denied for Addresses.Index, user: {User}", GetUserEmail());
            return View("PermissionError");
        }

        _logger.LogInformation("Addresses.Index requested by {User}", GetUserEmail());
    ...
    public async Task<IActionResult> Details(int? id)
    {
        if (GetAuthLevel() < (byte)AuthLevels.DataAdminReadOnly)
        {
            _logger.LogWarning("Permission denied for Addresses.Details, user: {User}", GetUserEmail());
            return View("PermissionError");
        }

        if (id == null)
        {
            _logger.LogWarning("Addresses.Details called with missing ID by {User}", GetUserEmail());
        ...
        if (publicIp == null)
        {
            _logger.LogWarning("Addresses.Details called with invalid ID {RangeId} by {User}", id, GetUserEmail());
            TempData["Message"] = "Invalid Prefix ID requested!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }

        _logger.LogInformation("Addresses.Details for range {Range} by {User}", publicIp.Range, GetUserEmail());
    ...
    public async Task<IActionResult> Edit(int? id)
    {
        ...
        {
            _logger.LogWarning("Permission denied for Addresses.Edit, user: {User}", GetUserEmail());
            return View("PermissionError");
        }

        if (id == null)
        {
            _logger.LogWarning("Addresses.Edit called with missing ID by {User}", GetUserEmail());
            TempData["Message"] = "Request missing required Prefix ID!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }
        ...
        if (publicIp == null)
        {
            _logger.LogWarning("Addresses.Edit called with invalid ID {RangeId} by {User}", id, GetUserEmail());
            TempData["Message"] = "Invalid Prefix ID requested!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }
        ...
        _logger.LogInformation("Addresses.Edit page for range {Range} by {User}", publicIp.Range, GetUserEmail());
        return View(publicIp);
    }
    ...
    public async Task<IActionResult> Edit(int id, PublicIp publicIp)
    {
        if (GetAuthLevel() < (byte)AuthLevels.DataAdmin)
        {
            _logger.LogWarning("Permission denied for Addresses.Edit [POST], user: {User}", GetUserEmail());
            return View("PermissionError");
        }
    ...
    public async Task<IActionResult> Release(int? id)
    {
        if (GetAuthLevel() < (byte)AuthLevels.DataAdmin)
        {
            _logger.LogWarning("Permission denied for Addresses.Release, user: {User}", GetUserEmail());
            return View("PermissionError");
        }

        if (id == null)
        {
            _logger.LogWarning("Addresses.Release called with missing ID by {User}", GetUserEmail());
            TempData["Message"] = "Request missing required Prefix ID!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }
        ...
        if (publicIp == null)
        {
            _logger.LogWarning("Addresses.Release called with invalid ID {RangeId} by {User}", id, GetUserEmail());
            TempData["Message"] = "Invalid Prefix ID requested!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }

        _logger.LogInformation("Addresses.Release confirmation for range {Range} by {User}", publicIp.Range, GetUserEmail());
        return View(publicIp);
    }
    ...
    public async Task<IActionResult> ReleaseConfirmed(int id)
    {
        if (GetAuthLevel() < (byte)AuthLevels.DataAdmin)
        {
            _logger.LogWarning("Permission denied for Addresses.Release [POST], user: {User}", GetUserEmail());
            return View("PermissionError");
        }
        ...
        if (publicIp == null)
        {
            _logger.LogWarning("Addresses.Release [POST] called with invalid ID {RangeId} by {User}", id, GetUserEmail());
            TempData["Message"] = "Invalid Prefix ID requested!";
            TempData["MessageLevel"] = "danger";
            return RedirectToAction(nameof(Index));
        }
