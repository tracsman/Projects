...
- For Lab VM work, the target Hyper-V server is determined by the first digit of the TenantId, not ConfigVersion. For example, TenantId 10 and 11 go to Server 01 (SEA-ER-01), TenantId 22 and 28 go to Server 02 (SEA-ER-02), TenantId 81 goes to Server 08 (SEA-ER-08).
